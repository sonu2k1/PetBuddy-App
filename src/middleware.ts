...
export function middleware(req: NextRequest) {
    ...
    response.headers.set(
        ...
        [
            ...
            "connect-src 'self' https://generativelanguage.googleapis.com https://api.bigdatacloud.net https://nominatim.openstreetmap.org https://res.cloudinary.com https://images.unsplash.com",
